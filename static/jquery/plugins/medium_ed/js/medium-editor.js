...
"object" == typeof module && (module.exports = MediumEditor), function (a, b) {
  ...
  function e(b) {
	...
	if (b)for (e.removeAllRanges(), c = 0, d = b.length; d > c; c += 1)e.addRange(b[c])
  }

  function f() {
	var a = b.getSelection().anchorNode, c = a && 3 === a.nodeType ? a.parentNode : a;
	return c
  }
  ...
  MediumEditor.prototype = {
	...
	setup: function () {
	  this.isActive = !0, this.initElements().bindSelect().bindPaste().setPlaceholders().bindWindowActions().passInstance()
	},
	...
	serialize: function () {
	  var a, b, c = {};
	  for (a = 0; a < this.elements.length; a += 1)b = "" !== this.elements[a].id ? this.elements[a].id : "element-" + a, c[b] = {value: this.elements[a].innerHTML.trim()};
	  return c
	},
	...
	passInstance: function () {
	  var a, b, c = this;
	  for (b in c.options.extensions)c.options.extensions.hasOwnProperty(b) && (a = c.options.extensions[b], a.parent && (a.base = c));
	  return c
	},
	...
	bindReturn: function (a) {
	  var b = this;
	  return this.elements[a].addEventListener("keypress", function (a) {
		if (13 === a.which)if (b.options.disableReturn || this.getAttribute("data-disable-return"))a.preventDefault(); else if (b.options.disableDoubleReturn || this.getAttribute("data-disable-double-return")) {
		  var c = f();
	...
	buttonTemplate: function (a) {
	  var b = this.getButtonLabels(this.options.buttonLabels), c = {
	...
	getButtonLabels: function (a) {
	  ...
	  if ("fontawesome" === a ? b = {
		  ...
		  } : "object" == typeof a && (b = a), "object" == typeof b)for (c in b)b.hasOwnProperty(c) && (d[c] = b[c]);
	  return d
	},
	...
	toolbarButtons: function () {
	  var a, c, d, e, f = this.options.buttons, g = b.createElement("ul");
	...
	toolbarFormAnchor: function () {
	  var a = b.createElement("div"), c = b.createElement("input"), d = b.createElement("a");
	...
	hasMultiParagraphs: function () {
	  var a = g().replace(/<[\S]+><\/[\S]+>/gim, ""), b = a.match(/<(p|h[0-6]|blockquote)>([\s\S]*?)<\/(p|h[0-6]|blockquote)>/g);
	  return b ? b.length : 0
	},
	checkSelectionElement: function (a, b) {
	  var c;
	  for (this.selection = a, this.selectionRange = this.selection.getRangeAt(0), c = 0; c < this.elements.length; c += 1)if (this.elements[c] === b)return void this.setToolbarButtonStates().setToolbarPosition().showToolbarActions();
	  this.hideToolbarActions()
	},
	getSelectionElement: function () {
	  var b, c, d, e, f = a.getSelection(), g = function (a) {
		var b = a;
		try {
	...
	setToolbarPosition: function () {
	  var b = 50, c = a.getSelection(), d = c.getRangeAt(0), e = d.getBoundingClientRect(), f = this.options.diffLeft - this.toolbar.offsetWidth / 2, g = (e.left + e.right) / 2, h = this.toolbar.offsetWidth / 2;
	...
	getSelectedParentElement: function () {
	  var a = null, b = this.selectionRange;
	...
	bindAnchorForm: function () {
	  var a = this.anchorForm.querySelector("a"), b = this;
	...
	showAnchorPreview: function (b) {
	  ...
	  var c, d, e, f = this, g = 40, h = b.getBoundingClientRect(), i = (h.left + h.right) / 2;
	...
	observeAnchorPreview: function (a) {
	  var b = this, c = (new Date).getTime(), d = !0, e = function () {
	...
	createAnchorPreview: function () {
	  var a = this, c = b.createElement("div");
	...
	anchorPreviewClickHandler: function () {
	  if (this.activeAnchor) {
		var c = this, d = b.createRange(), e = a.getSelection();
	...
	setTargetBlank: function () {
	  var a, b = f();
	  if ("a" === b.tagName.toLowerCase())b.target = "_blank"; else for (b = b.getElementsByTagName("a"), a = 0; a < b.length; a += 1)b[a].target = "_blank"
	},
	...
	bindPaste: function () {
	  ...
	  for (this.pasteWrapper = function (a) {
		...
		if (a.clipboardData && a.clipboardData.getData && !a.defaultPrevented) {
		  ...
		  if (c.options.disableReturn || this.getAttribute("data-disable-return"))b.execCommand("insertHTML", !1, a.clipboardData.getData("text/plain")); else {
